...
module.exports.run = async (bot, message, args) => {
  ...
  let gRole = message.mentions.roles.first() || message.guild.roles.find(role => role.name === args[1]);
  ...
  try {
    ...
    .setTimestamp()
    .setDescription(`<:green_tick:566945998761361408> Successfully removed the role, ${gRole} from <@${rMember.id}>`);
