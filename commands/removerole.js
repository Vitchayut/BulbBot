...
module.exports.run = async (bot, message, args) => {
  ...
  try {
    await rMember.send(`<:green_tick:566945998761361408> \`You lost the role, ${gRole.name}\``)
  } catch (e) {
    console.log(e.stack);
    message.channel.send(`<:green_tick:566945998761361408> \`**R.I.P** to <@${rMember.id}>, the role ${gRole.name} have been taken away!\nWe tried to DM them, but their DMs are locked.\``)
  }
}
